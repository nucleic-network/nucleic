...
type BlockDescriptors struct {
	BlockDescs []BlockDescriptor `protobuf:"bytes,1,rep,name=block_descs,json=blockDescs,proto3" json:"block_descs"`
}
...
func (m *BlockDescriptors) GetBlockDescs() []BlockDescriptor {
	if m != nil {
		return m.BlockDescs
	}
	return nil
...
var fileDescriptor_fccbdab1f9ac4db2 = []byte{
	...
	,
}
...
func (m *BlockDescriptors) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BlockDescs) > 0 {
		for iNdEx := len(m.BlockDescs) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.BlockDescs[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *BlockDescriptors) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.BlockDescs = append(m.BlockDescs, BlockDescriptor{})
			if err := m.BlockDescs[len(m.BlockDescs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
